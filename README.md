...
- [ ] 포털 웹
   ...
   - [ ] Project: Cone
     ...
     - [ ] 공개 게시물 관리와 각 사람별 게시물 관리 (기능만 제공하는 방식, 사설 서버 등의 자료를 관리)
       - [ ] 게시요청을 로컬에서 기록해두었다가 반영완료되면 로컬 기록 삭제
   - [ ] 분야별 게시판
      - [ ] 글쓰기
        - [ ] 단문
        - [ ] 단편
...
## Android 빌드 작업보조 정보글
- apt install openjdk-8-jdk 로 Java 1.8.0 을 설치한 후 안드로이드 스튜디오에서 버전 변경 (Ctrl + Alt + Shift + S)
...
- 7350-7352: Nakama
### 커뮤니티 서버 포트
향후 프로토콜 분리 형식으로 변경하여 12000 포트만 사용하도록 해야함
- 12000: SingleAct_카운터
- 12010: Exim4
