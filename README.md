...
- [x] 메인 페이지 구성
- [x] 캠페인식 컴까기 상세 페이지(사진 돌려보기, 파일 다운받기, 버전 로그 보기)
- [ ] ~~리모콘 기능 테스트~~
  - 테스트는 되었으나 기능은 삭제됨
- [x] 서버와의 소통 테스트
...
- [ ] 포털 (Root)
   - [ ] 개인 블로그
   - [ ] 작성자인 나도 웹에서 서버에 작성할 수 있어야하며 자료관리가 이루어져야함
   - [ ] 개인 사담
   - [ ] 작업 기록 아카이브
   - [ ] 방명록, 관리자에게만 보이기, 답글달기
   - [ ] 최고관리자 권한 전용 페이지: 광고 관리자
   - [x] 캠페인식 컴까기
     - 설명
     - 파일 받기
     - 방명록, 답글달기 (누구나)
...
- [x] github를 겨냥한 자체 서버, 한개 노드 아래에서 다중 서버 운용됨
  - [x] 이메일 아이디 / 기기uid 비밀번호
    ...
    - [ ] 사용자 인계 후 영구적으로 계정 이어받기 (uuid 비밀번호 변경)
...
- [ ] ~~게시물을 페이지화 시키고 필요한 만큼만 자료 불러오기 (pagenation 또는 infinite-scroll)~~ 나카마에 페이지네이션 기능이 있음
